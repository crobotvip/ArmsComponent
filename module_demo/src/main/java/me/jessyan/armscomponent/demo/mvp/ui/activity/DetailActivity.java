...
import me.jessyan.armscomponent.demo.di.component.DaggerDetailComponent;
import me.jessyan.armscomponent.demo.mvp.contract.DetailContract;
import me.jessyan.armscomponent.demo.mvp.model.entity.ZhihuDetailBean;
import me.jessyan.armscomponent.demo.mvp.presenter.DetailPresenter;
 ...
 * ================================================
 */
@Route(path = RouterHub.DEMO_DETAILACTIVITY)
public class DetailActivity extends BaseActivity<DetailPresenter> implements DetailContract.View {
    ...
    public int initView(@Nullable Bundle savedInstanceState) {
        return R.layout.demo_activity_detail; //如果你不需要框架帮你设置 setContentView(id) 需要自行设置,请返回 0
    }
