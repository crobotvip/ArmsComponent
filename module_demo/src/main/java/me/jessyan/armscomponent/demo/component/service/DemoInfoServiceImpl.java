 ...
 */
package me.jessyan.armscomponent.demo.component.service;
...
import me.jessyan.armscomponent.commonservice.demo.bean.DemoInfo;
 ...
 * ================================================
 */
@Route(path = RouterHub.DEMO_SERVICE_ZHIHUINFOSERVICE, name = "知乎信息服务")
public class DemoInfoServiceImpl implements DemoInfoService {
    private Context mContext;

    @Override
    public DemoInfo getInfo() {
        return new DemoInfo(ArmsUtils.getString(mContext, R.string.public_name_demo));
    }
