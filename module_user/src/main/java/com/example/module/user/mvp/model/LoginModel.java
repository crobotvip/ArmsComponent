package com.example.module.user.mvp.model;

import android.app.Application;

import com.example.module.user.mvp.model.api.service.UserService;
...
public class LoginModel extends BaseModel implements LoginContract.Model {
    ...
    public Observable<BaseResponse<LoginResponse>> login(String username, String password) {
        return mRepositoryManager
                .obtainRetrofitService(UserService.class).login(username,password,"");
    }
}